...
public class EnderecoServiceTest {
    ...
    public void teste_recuperar_lista_enderecos() {
        ...
        listEnderecoEsperada.add(new Endereco(79860L, "Rua J", "Bairro J", "Cidade J", "Estado J"));
        listEnderecoEsperada.add(new Endereco(79860L, "Rua J", "Bairro J", "Cidade J", "Estado J"));
        ...
        assertThat(listEnderecoResposta).withFailMessage("O retorno do metodo listar deve ser uma lista de endereco")
                .isInstanceOf(List.class);

        assertThat(listEnderecoResposta)
                .withFailMessage("O retorno do metodo listar deve ser uma lista de endereco não nula").isNotNull();

        assertThat(listEnderecoResposta.size())
                .withFailMessage("O retorno do metodo listar deve ser uma lista com dois enderecos").isEqualTo(2);
    }
    ...
    @Test
    public void teste_alterar_status_endereco_por_id() {
        // GIVEN - Dada alguma(s) pré-condição (arrange)

        Long idEndereco = 10L;
        Endereco enderecoEnviado = new Endereco(49000000L, "Rua A", "Bairro A", "Cidade A", "Estado A");
        enderecoEnviado.setId(idEndereco);
        enderecoEnviado.setStatus(EnderecoStatus.ATIVO);
        ...
        Endereco enderecoComStatusAlterado = enderecoService.mudarStatus(enderecoEnviado.getId(),
                enderecoEnviado.getStatus());
